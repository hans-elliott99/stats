...
The change in the size of the infected population, $y$, over time, $t$, with total population, $P$, can be modeled by:  
...
Solution curves for three different infection rates ($k$) are shown - the larger the $k$, the faster the infected population $y$ grows to the total population $P$.  
