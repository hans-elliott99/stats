...
Notes based on McCullagh and Nelder (N&M), 1983, section 3.8.2 and [Interactive Linear Algebra](https://textbooks.math.gatech.edu/ila/orthogonal-sets.html) (ILA).
...
This means the first $p$ rows of the augmented matrix $\{R : u\}$ can be used to get the coefficients. (N&M, pg. 87). 
